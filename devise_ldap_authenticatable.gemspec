...
Gem::Specification.new do |s|
  ...
  s.authors = ["Curtis Schiewek", "Daniel McNevin", "Anton Versal"]
  s.date = %q{2011-04-08}
  s.description = %q{LDAP authentication module for Devise}
  s.email = %q{curtis.schiewek@gmail.com anton.versal@gmail.com}
  s.extra_rdoc_files = [
    "README.md"
  ]
  s.files = [
  ...
  s.homepage = %q{http://github.com/antonversal/devise_ldap_authenticatable}
  s.require_paths = ["lib"]
